<template>
    <b-row class="infoAndImage">
        ...
        <b-col cols="4" class="text-right text-dark">
            ...
            <span v-if="country_code" :class="['flag flag-icon flag-icon-squared rounded-circle border border-secondary fa-4x', 'flag-icon-' + country_code.toLowerCase()]"></span>
            <i v-else="country_code" class="fas fa-4x fa-globe-americas"></i>
